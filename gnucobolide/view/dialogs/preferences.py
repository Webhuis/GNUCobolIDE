...
from gnucobolide import system, compilers
from gnucobolide.enums import GnuCobolStandard
from gnucobolide.settings import Settings
from gnucobolide.view.forms import dlg_preferences_ui
from gnucobolide.view.dialogs.check_compiler import DlgCheckCompiler
from gnucobolide.view.dialogs.cobc_help import DlgCobcHelp
...
DEFAULT_TEMPLATE = '''      * Author:
      ...
      *-----------------------
       ...
       01  filler pic x(36) value 'Start of working storage section.'.
      *-----------------------
       procedure division.
      *-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-
       main-procedure.

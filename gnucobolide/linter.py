...
from gnucobolide import settings, system
from gnucobolide.compilers import GnuCobolCompiler
...
def lint(request_data):
    ...
    """
    print('running gnucobolide.linter.lint')
    code = request_data['code']
    path = request_data['path']
    extension = os.path.splitext(path)[1]
    print('valid compiler extensions: %r' % settings.Settings().cobc_extensions)
    messages = []

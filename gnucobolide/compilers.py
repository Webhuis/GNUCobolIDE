...
from gnucobolide import system, msvc
from gnucobolide.enums import FileType, GnuCobolStandard
from gnucobolide.memoize import memoized
...
def run_command(pgm, args, working_dir=''):
    ...
    try:
        ...
        # https://github.com/GNUCobolIDE/GNUCobolIDE/issues/188
...
class GnuCobolCompiler(QtCore.QObject):
    ...
    # See https://github.com/GNUCobolIDE/GNUCobolIDE/issues/206
    ...
    def setup_process_environment():
        ...
        if not s.vcvarsall:
            ...
            for k, v in msvc.get_vc_vars( s.vcvarsall, s.vcvarsall_arch).items():
                if k == 'PATH':
    ...
    def check_compiler(cls, compiler):
        ...
        from gnucobolide.view.dialogs.preferences import DEFAULT_TEMPLATE
